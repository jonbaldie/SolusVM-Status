...
<div style="width: 90%; max-width: 800px; margin: 0 auto;">
    ...
    <?php else: ?>
        ...
        <?php if ($action == "info"): ?>
            ...
            <h3>Hard Disk usage
                <small><?php echo humanFileSize($return['hdd'][1]); ?> used of <?php echo humanFileSize(
                        $return['hdd'][0]
                    ); ?></small>
            </h3>
            <div class="progress">
                <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo $return['hdd'][3]; ?>"
                     aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $return['hdd'][3]; ?>%;">
                    <?php echo $return['hdd'][3]; ?>%
                </div>
            </div>

            <h3>RAM usage
                <small><?php echo humanFileSize($return['mem'][1]); ?> used of <?php echo humanFileSize(
                        $return['mem'][0]
                    ); ?></small>
            </h3>
            <div class="progress">
                <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo $return['mem'][3]; ?>"
                     aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $return['mem'][3]; ?>%;">
            ...
            <div class="progress">
                <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo $return['bw'][3]; ?>"
                     aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $return['bw'][3]; ?>%;">
